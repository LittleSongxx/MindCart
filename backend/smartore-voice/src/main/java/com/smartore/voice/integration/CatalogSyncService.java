...
import com.smartore.voice.service.ProductTextBuilder;
import com.smartore.voice.service.ProductVectorService;
...
/**
 * 商品目录同步：Smartore goods 服务 → 本地 voice_product（向量检索副本）。
 * <p>
...
public class CatalogSyncService {
    ...
    private ProductEntity upsert(ProductSyncVO vo) {
        ...
        // Smartore 类目是单层结构：l1/l2 同取类目名，保持检索/归一化两侧口径一致
