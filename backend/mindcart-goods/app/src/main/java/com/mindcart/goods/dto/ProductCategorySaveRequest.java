...
public class ProductCategorySaveRequest {
    ...
    @Size(max = 50, message = "分类名称长度不能超过50", groups = {Create.class, Update.class})
    private String name;

    @Size(max = 255, message = "分类图标地址长度不能超过255", groups = {Create.class, Update.class})
    private String icon;
    ...
    @Size(max = 500, message = "备注长度不能超过500", groups = {Create.class, Update.class})
