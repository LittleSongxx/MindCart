...
public class ProductService {
    ...
    @Resource
    private com.mindcart.goods.mapper.StockMapper stockMapper;
    ...
    @Cacheable(value = GoodsCacheNames.PRODUCT,
            key = "T(com.mindcart.goods.cache.GoodsCacheKeys).productKey(#product)",
            condition = "T(com.mindcart.goods.cache.GoodsCacheKeys).cacheable(#product)",
            sync = true)
