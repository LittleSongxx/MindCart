...
import com.mindcart.goods.cache.GoodsCacheKeys;
import com.mindcart.goods.cache.GoodsCacheNames;
import com.mindcart.goods.entity.StockChangeRecord;
import com.mindcart.goods.mapper.StockChangeRecordMapper;
import com.mindcart.goods.mapper.StockMapper;
...
public class StockSagaService {
    ...
    /**
     * 用 ObjectProvider 而非直接注入：缓存是可选的加速层（mindcart.cache.enabled 默认 false），
