...
public class WalletSagaService {
    ...
    public com.mindcart.user.api.WalletStatusVO statusOf(String orderNo) {
        com.mindcart.user.api.WalletStatusVO status = new com.mindcart.user.api.WalletStatusVO();
