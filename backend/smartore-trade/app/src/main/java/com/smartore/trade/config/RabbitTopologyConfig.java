package com.smartore.trade.config;
...
public class RabbitTopologyConfig {
    ...
    public static final String QUEUE_EVENT = "smartore.trade.event";
    public static final String DLX = "smartore.dlx";
    public static final String QUEUE_EVENT_DEAD = "smartore.trade.event.dead";
