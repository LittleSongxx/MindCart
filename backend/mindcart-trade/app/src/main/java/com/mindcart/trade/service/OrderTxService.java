package com.mindcart.trade.service;

import com.mindcart.trade.api.TradeEventPayload;
import com.mindcart.trade.entity.OrderRequestIdempotency;
...
import com.mindcart.trade.mapper.OrderRequestIdempotencyMapper;
import com.mindcart.trade.mapper.ShopOrderItemMapper;
import com.mindcart.trade.mapper.ShopOrderMapper;
import com.mindcart.trade.mapper.ShoppingCartMapper;
...
public class OrderTxService {
    ...
    public void persistOrder(ShopOrder order, List<ShopOrderItem> items, List<ShoppingCart> cartList,
        ...
        if (idempotencyMapper.insertIgnore(idempotency) == 0) {
            ...
            throw new com.mindcart.common.exception.CustomException(
                    com.mindcart.common.result.ResultCodeEnum.CONFLICT);
        }
    }
