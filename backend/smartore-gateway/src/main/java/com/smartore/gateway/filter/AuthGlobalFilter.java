...
public class AuthGlobalFilter implements GlobalFilter, Ordered {
    ...
    @org.springframework.beans.factory.annotation.Value("${smartore.gateway-token:}")
    ...
    public void checkSecret() {
        ...
        if (StrUtil.isBlank(gatewayToken)) {
            throw new IllegalStateException("smartore.gateway-token 必须配置（scripts/dev.sh bootstrap 自动生成）");
        }
    }
