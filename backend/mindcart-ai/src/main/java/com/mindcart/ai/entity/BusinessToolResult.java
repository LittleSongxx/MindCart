...
public class BusinessToolResult {
    ...
    private List<com.mindcart.goods.api.ProductVO> similarProducts;
    ...
    public List<com.mindcart.goods.api.ProductVO> getSimilarProducts() {
        return similarProducts;
    }

    public void setSimilarProducts(List<com.mindcart.goods.api.ProductVO> similarProducts) {
