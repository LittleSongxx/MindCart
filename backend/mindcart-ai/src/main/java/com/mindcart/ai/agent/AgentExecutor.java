...
import com.mindcart.ai.agent.tools.SubmitRecommendationsTool;
...
import com.mindcart.ai.service.AgentStepService;
import com.mindcart.ai.service.AiChatService;
import com.mindcart.ai.service.ProductToolService;
import com.mindcart.ai.service.ShoppingRecommendationService;
...
public class AgentExecutor {
    ...
    @Resource
    private com.mindcart.ai.mapper.ShoppingGuideTaskMapper taskMapper;
    ...
    private String buildErrorMessage(RuntimeException e) {
        if (e instanceof com.mindcart.common.exception.CustomException custom) {
    ...
    private <T> T unwrap(Result<T> result) {
        if (result == null || !ResultCodeEnum.SUCCESS.getCode().equals(result.getCode())) {
            throw new com.mindcart.common.exception.CustomException(ResultCodeEnum.SYSTEM_ERROR,
