...
import com.mindcart.goods.api.AfterSaleRuleVO;
...
import com.mindcart.ai.entity.ShoppingQaRequest;
import com.mindcart.common.exception.CustomException;

import com.mindcart.ai.mapper.ShoppingQaMapper;
...
public class ShoppingQaService {
    ...
    @Resource
    private com.mindcart.ai.mapper.QaConversationMapper qaConversationMapper;
    @Resource
    private com.mindcart.ai.mapper.ShoppingQaMapper shoppingQaMapperDirect;
    ...
    public ShoppingQa ask(ShoppingQaRequest request, java.util.function.Consumer<String> deltaSink) {
        ...
        Integer currentUserId = com.mindcart.common.context.UserContext.getUserIdOrNull();
        ...
        qa.setQaNo(com.mindcart.common.util.BizNoGenerator.next("QA"));
    ...
    private void requireOwnedOrAdmin(Integer id) {
        ...
        if (qa == null || !qa.getUserId().equals(com.mindcart.common.context.UserContext.requireUserId())) {
    ...
    private void visibleCondition(ShoppingQa shoppingQa) {
        if (!com.mindcart.common.context.UserContext.isAdmin()) {
            shoppingQa.setUserId(com.mindcart.common.context.UserContext.requireUserId());
        }
    }
    ...
    private void attachConversation(ShoppingQaRequest request) {
        if (request.getConversationId() != null) {
            com.mindcart.ai.entity.QaConversation existing = qaConversationMapper.selectById(request.getConversationId());
            if (existing != null) {
        ...
        com.mindcart.ai.entity.QaConversation conversation = new com.mindcart.ai.entity.QaConversation();
    ...
    private Integer nextRoundNo(Integer conversationId) {
        com.mindcart.ai.entity.ShoppingQa condition = new com.mindcart.ai.entity.ShoppingQa();
    ...
    private String buildHistoryContext(Integer conversationId) {
        ...
        com.mindcart.ai.entity.ShoppingQa condition = new com.mindcart.ai.entity.ShoppingQa();
        condition.setConversationId(conversationId);
        List<com.mindcart.ai.entity.ShoppingQa> history = shoppingQaMapperDirect.selectAll(condition);
        if (history.isEmpty()) {
            return "";
        }
        ...
        for (int i = 0, taken = 0; i < history.size() && taken < 3; i++, taken++) {
            com.mindcart.ai.entity.ShoppingQa round = history.get(i);
    ...
    public List<com.mindcart.ai.entity.QaConversation> myConversations(Integer userId) {
    ...
    private void answerProductQuestion(ShoppingQaRequest request, ShoppingQa qa,
        ...
        com.mindcart.goods.api.ProductVO product = resolveProduct(request);
        ...
        String answer;
        if (deltaSink != null) {
            com.mindcart.ai.entity.AiModelConfig chatConfig = aiChatService.resolveEnabledConfig("CHAT");
    ...
    private void answerAfterSaleQuestion(ShoppingQaRequest request, ShoppingQa qa) {
        com.mindcart.goods.api.ProductVO product = resolveProductIfPossible(request);
    ...
    private List<AfterSaleRuleVO> unwrapRules() {
        com.mindcart.common.result.Result<List<AfterSaleRuleVO>> result = goodsClient.enabledAfterSaleRules();
        if (result == null || !com.mindcart.common.result.ResultCodeEnum.SUCCESS.getCode().equals(result.getCode())) {
            return List.of();
        }
