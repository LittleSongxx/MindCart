...
public class ProductKnowledgeEmbeddingService {
    ...
    public static final String PROGRESS_KEY = "mindcart:ai:embedding:progress";
    public static final String LOCK_KEY = "mindcart:ai:embedding:lock";
    ...
    private String buildSearchText(EmbeddingSearchRequest request) {
        ...
        com.mindcart.common.result.Result<com.mindcart.goods.api.ProductVO> result =
                goodsClient.getProduct(request.getProductId());
        com.mindcart.goods.api.ProductVO product = result == null || !"200".equals(result.getCode())
                ? null : result.getData();
