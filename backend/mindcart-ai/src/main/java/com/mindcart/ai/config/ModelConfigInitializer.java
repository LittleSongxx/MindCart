...
import com.mindcart.ai.mapper.AiModelConfigMapper;
...
public class ModelConfigInitializer implements ApplicationRunner {
    ...
    @Value("${mindcart.model.chat.api-key:}")
    private String chatApiKey;
    @Value("${mindcart.model.chat.base-url:https://api.deepseek.com/v1}")
    private String chatBaseUrl;
    @Value("${mindcart.model.chat.model-name:deepseek-chat}")
    private String chatModelName;
    @Value("${mindcart.model.embedding.api-key:}")
    private String embeddingApiKey;
    @Value("${mindcart.model.embedding.base-url:https://dashscope.aliyuncs.com/compatible-mode/v1}")
    private String embeddingBaseUrl;
    @Value("${mindcart.model.embedding.model-name:text-embedding-v4}")
    private String embeddingModelName;

    @Resource
    private AiModelConfigMapper mapper;
    @Resource
    private com.mindcart.ai.service.AiModelConfigService configService;
