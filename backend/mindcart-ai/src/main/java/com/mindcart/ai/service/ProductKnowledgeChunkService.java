...
public class ProductKnowledgeChunkService {
    ...
    public List<ProductKnowledgeChunk> selectAll(ProductKnowledgeChunk productKnowledgeChunk) {
        List<com.mindcart.ai.entity.ProductKnowledgeChunk> __rows = productKnowledgeChunkMapper.selectAll(productKnowledgeChunk);
        nameFillService.fillProducts(__rows, com.mindcart.ai.entity.ProductKnowledgeChunk::getProductId, (row, p) -> {
