...
import com.mindcart.ai.service.ShoppingQaService;
...
public class ShoppingQaController {
    ...
    public SseEmitter askStream(@RequestParam(required = false) Integer userId,
        ...
        Integer currentUserId = com.mindcart.common.context.UserContext.requireUserId();
    ...
    static {
        int core = Integer.getInteger("mindcart.qa.sse.core-threads", 8);
        int max = Integer.getInteger("mindcart.qa.sse.max-threads", 16);
        int queue = Integer.getInteger("mindcart.qa.sse.queue-capacity", 64);
    ...
    public com.mindcart.common.result.Result<java.util.List<com.mindcart.ai.entity.QaConversation>> conversations() {
        return com.mindcart.common.result.Result.success(
                shoppingQaService.myConversations(com.mindcart.common.context.UserContext.requireUserId()));
    }
}
