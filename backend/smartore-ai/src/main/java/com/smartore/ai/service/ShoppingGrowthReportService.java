...
import com.smartore.ai.entity.GrowthReportRequest;
...
import com.smartore.ai.mapper.ShoppingGrowthReportMapper;
...
public class ShoppingGrowthReportService {
    ...
    private com.smartore.trade.api.OrderGlobalStatsVO unwrapOrders() {
        com.smartore.common.result.Result<com.smartore.trade.api.OrderGlobalStatsVO> result = orderClient.globalStats();
        if (result == null || !"200".equals(result.getCode()) || result.getData() == null) {
            return new com.smartore.trade.api.OrderGlobalStatsVO();
        }
    ...
    public ShoppingGrowthReport generate(GrowthReportRequest request) {
        ...
        com.smartore.trade.api.OrderGlobalStatsVO orderStats = unwrapOrders();
