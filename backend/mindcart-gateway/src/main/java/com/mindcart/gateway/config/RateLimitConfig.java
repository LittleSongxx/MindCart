package com.mindcart.gateway.config;
...
public class RateLimitConfig {
    ...
    public RedisRateLimiter redisRateLimiter(
            @org.springframework.beans.factory.annotation.Value("${MINDCART_RATE_REPLENISH:20}") int replenish,
            @org.springframework.beans.factory.annotation.Value("${MINDCART_RATE_BURST:60}") int burst) {
